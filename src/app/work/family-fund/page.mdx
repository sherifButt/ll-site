...
export const caseStudy = {
  ...
  testimonial: {
    ...
    content:
      'Working with Loyalleads, we felt more like a partner than a customer. They really resonated with our mission to change the way people convince their parents to cash out their pensions.',
  },
}
...
>
  Working with Loyalleads, we felt more like a partner than a customer. They really
