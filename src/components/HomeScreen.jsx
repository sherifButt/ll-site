...
const ScaledView = () => {
  return (
    <div className="min-h-screen w-full overflow-x-hidden bg-gray-50">
      <div className="w-ful h-6 bg-white"></div><div
      ...
      >
        ...
        {/* Your original component goes here */}
        <Example />
      </div>
    </div>
  )
  ...
  return (
    <>
      ...
      <header className="absolute inset-x-0 top-0 z-50 flex h-16 border-b border-gray-900/10  ">
        ...
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8 z-50">
        ...
        <div className="relative isolate overflow-hidden bg-white  pt-16">
          ...
          <header className="pb-4 pt-6 sm:pb-6">
            <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-6 px-4 sm:flex-nowrap sm:px-6 lg:px-8">
              ...
              >
                <PlusSmallIcon aria-hidden="true" className="size-5 -ml-1.5" />
                New invoice
              </a>
            </div>
          </header>
