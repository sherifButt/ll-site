          ...
          <div className="flow-root bg-gray-900 py-16 sm:pt-32 lg:pb-0">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="relative z-10">
                <h1 className="text-balance mx-auto max-w-4xl text-center text-5xl font-semibold tracking-tight text-white sm:text-6xl">
                  Pricing that grows with you
                </h1>
                <p className="text-pretty mx-auto mt-6 max-w-2xl text-center text-lg font-medium text-gray-400 sm:text-xl/8">
                                        ...
                                        'string' ? (
                                          ...
                                          <>
                                            ...
                                            true ? (
                                              ...
                                              <XMarkIconMini
                                                aria-hidden="true"
                                                className="size-5 mx-auto text-gray-400"
                                              />
                                            )}
                            ...
                            {section.features.map((feature, featureIdx) => (
                              <tr key={feature.name}>
                                ...
                                {pricing.tiers.map((tier) => (
                                  ...
                                  >
                                    <span className="size-full relative py-3">
                                      {typeof feature.tiers[tier.name] ===
                                      'string' ? (
                                        <span
                                          className={classNames(
