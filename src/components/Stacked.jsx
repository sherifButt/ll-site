                    ...
                    {activityItem.type === 'commented' ? (
                      <>
                        <img
                          ...
                          className="size-6 relative mt-3 flex-none rounded-full bg-gray-50"
                        />
                      ...
                      <>
                        <div className="size-6 relative flex flex-none items-center justify-center bg-white">
                  ...
                  <div className="absolute inset-x-0 bottom-0 flex justify-between py-2 pl-3 pr-2">
                    <div className="flex items-center space-x-5">
                      <div className="flex items-center">
                        <button
                          type="button"
                          className="size-10 -m-2.5 flex items-center justify-center rounded-full text-gray-400 hover:text-gray-500"
                        >
                          <PaperClipIcon
                            aria-hidden="true"
                            className="size-5"
                      ...
                      <div className="flex items-center">
                        <Listbox value={selected} onChange={setSelected}>
                          ...
                          <div className="relative">
                            <ListboxButton className="size-10 relative -m-2.5 flex items-center justify-center rounded-full text-gray-400 hover:text-gray-500">
